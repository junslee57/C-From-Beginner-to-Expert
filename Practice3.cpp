...
int main()
{
    ...
    //TYPE_OF)VARIABLE nameOfVariable1, nameOfVariable2, nameOfVariable3;

    int a = 40, b, c = 20; //-2billions to 2 billions, 4 BYTES
    
    cout << "a : " << a << " address: " << &a << endl;
    cout << "b : " << b << " address: " << &b << endl;
    cout << "c : " << c << " address: " << &c << endl;

    short int t1 = 5.6; //-32768 tp 32767, 2 BYTES
